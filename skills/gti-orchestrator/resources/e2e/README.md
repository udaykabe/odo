...
```bash
cp -r .claude/skills/gti-orchestrator/resources/e2e/helpers/ <project-e2e-dir>/helpers/
cp -r .claude/skills/gti-orchestrator/resources/e2e/fixtures/ <project-e2e-dir>/fixtures/
cp .claude/skills/gti-orchestrator/resources/e2e/smoke-setup.ts <project-e2e-dir>/smoke-setup.ts
```
